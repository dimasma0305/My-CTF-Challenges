...
var ASM_CONSTS = {
  66536: ($0) => { document.getElementById("title").innerHTML = UTF8ToString($0) },  
 66600: ($0) => { document.querySelector("name").innerText = UTF8ToString($0) },  
 66662: () => { return stringToUTF8OnStack(decodeURI(location.hash.slice(1, location.hash.length))); }
};
...
/** @type {function(...*):?} */
var _setHeaderTag = Module["_setHeaderTag"] = createExportWrapper("setHeaderTag");
/** @type {function(...*):?} */
var _setNameTag = Module["_setNameTag"] = createExportWrapper("setNameTag");
/** @type {function(...*):?} */
var _getHash = Module["_getHash"] = createExportWrapper("getHash");
/** @type {function(...*):?} */
